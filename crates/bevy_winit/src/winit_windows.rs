...
pub struct WinitWindows {
    ...
    pub windows: HashMap<crate::winit::window::WindowId, crate::winit::window::Window>,
    /// Maps entities to `winit` window identifiers.
    pub entity_to_winit: EntityHashMap<crate::winit::window::WindowId>,
    /// Maps `winit` window identifiers to entities.
    pub winit_to_entity: HashMap<crate::winit::window::WindowId, Entity>,
...
impl WinitWindows {
    ...
    pub fn create_window(
        &mut self,
        event_loop: &crate::winit::event_loop::EventLoopWindowTarget<()>,
        entity: Entity,
        window: &Window,
        // adapters: &mut AccessKitAdapters,
        // handlers: &mut WinitActionHandlers,
        accessibility_requested: &AccessibilityRequested,
    ) -> &crate::winit::window::Window {
        let mut winit_window_builder = crate::winit::window::WindowBuilder::new();
        ...
        //         crate::winit::window::Fullscreen::Borderless(event_loop.primary_monitor()),
        //     )),
        ...
        //     ))]
        //     {
        //         winit_window_builder = crate::winit::platform::wayland::WindowBuilderExtWayland::with_name(
        //             winit_window_builder,
        //             name.clone(),
        //             "",
        //         );
        ...
        //     ))]
        //     {
        //         winit_window_builder = crate::winit::platform::x11::WindowBuilderExtX11::with_name(
        //             winit_window_builder,
        //             name.clone(),
        //             "",
        //         );
        ...
        //     {
        //         winit_window_builder =
        //             crate::winit::platform::windows::WindowBuilderExtWindows::with_class_name(
        //                 winit_window_builder,
        //                 name.clone(),
        //             );
        //     }
    ...
    pub fn get_window(&self, entity: Entity) -> Option<&crate::winit::window::Window> {
...
// ///
// /// The heuristic for "best" prioritizes width, height, and refresh rate in that order.
// pub fn get_best_videomode(monitor: &MonitorHandle) -> crate::winit::monitor::VideoMode {
//     let mut modes = monitor.video_modes().collect::<Vec<_>>();
//     modes.sort_by(|a, b| {
//         use std::cmp::Ordering::*;
...
pub(crate) fn attempt_grab(winit_window: &crate::winit::window::Window, grab_mode: CursorGrabMode) {
    // let grab_result = match grab_mode {
    //     CursorGrabMode::None => winit_window.set_cursor_grab(crate::winit::window::CursorGrabMode::None),
    //     CursorGrabMode::Confined => winit_window
    //         .set_cursor_grab(crate::winit::window::CursorGrabMode::Confined)
    //         .or_else(|_e| winit_window.set_cursor_grab(crate::winit::window::CursorGrabMode::Locked)),
    //     CursorGrabMode::Locked => winit_window
    //         .set_cursor_grab(crate::winit::window::CursorGrabMode::Locked)
    //         .or_else(|_e| winit_window.set_cursor_grab(crate::winit::window::CursorGrabMode::Confined)),
    // };
